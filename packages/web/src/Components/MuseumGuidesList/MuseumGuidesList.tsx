...
import style from './MuseumGuidesList.module.scss';
import MuseumGuideItemContainer from './MuseumGuideItem/MuseumGuideItemContainer';

const MuseumGuidesList = ({
	getData,
	serviceIds,
	currentPage,
	totalPage,
	...
	search,
	status,
}: TMuseumGuidesListProps) => {
	const ObjectCreateLink = useRouterLinkForMui(Routes.museumGuide());
	...
	return (
		<PageListIteration
			...
			labelAdd="Добавить музейный гид"
		...
		>
			<Grid container className={style.table} direction="column">
				...
				<div className={style.container}>
					{_.map(serviceIds, (id) => (
						<MuseumGuideItemContainer key={id} id={id} />
					))}
				</div>
			</Grid>
		</PageListIteration>
...
export default MuseumGuidesList;
